const translations = {
  ru: {
    ...
    "about.text": "Занимаюсь backend-разработкой: API, базы данных, деплой. Основной стек — PHP/Laravel и Java. Также работаю с PostgreSQL, Docker, Linux и JavaScript. Параллельно прохожу обучение по направлению «Информационные системы» в ВИВТ (2025–2028).",
    "stack.title": "Стек",
  ...
  en: {
    ...
    "about.text": "I work on backend development: APIs, databases, deployment. Main stack — PHP/Laravel and Java. Also PostgreSQL, Docker, Linux, and JavaScript. Currently studying Information Systems at VIHT (2025–2028).",
    "stack.title": "Stack",
